...
class Dictionary_DAL extends DataAbstractionLayer {
	...
	protected $primaryKeyColumnName = 'dict_id';
 ...
 */
    ...
    if(empty($this->langNum))
        throw new Exception('BcmsConfig not yet initialized. Dictionary cannot be used, yet!');
	...
	public function getTransByDefault($default) {
		...
		$default = BcmsSystem::getParser()->prepDbStrng($default);
