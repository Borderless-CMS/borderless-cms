 ...
 */
	...
	protected function __construct() {
		...
		$this->col['editable']['qf_vals'] = Factory::getObject('Dictionary')->getDalObj()->getYesNoArray();
		$this->setTypeSelect();
	...
	public function getList($offset=null,$limit=null,$where=null,$searchphrase=null, $order_by=null, $order_dir=null)
	{
		...
		$this->sql['list4view'] = array(
				...
				'order' => 'class.name, config.var_name',
	...
	// URGENT use classifications for Typeselect
	public function setTypeSelect(){
		$this->sql['var_type'] = array(
				'select' => 'class.classify_id, class.name',
		...
		for ($i = 0; $i < sizeof($types); $i++) {
			$typeValues[$types[$i]['classify_id']] = $types[$i]['name'];
		}
		unset($types);
